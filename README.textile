...
bq. I've extracted and reorganized the solr analyzer filters into a new repo
at https://github.com/billdueber/solr-libstdnum-normalize. This repo will no longer be updated.

bq. I'll figure out what todo with the HLB stuff later.
